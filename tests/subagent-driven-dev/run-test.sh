...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/superskills
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/superskills-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using superskills:subagent-driven-development. The plan is at: $PLAN_PATH"
