...
mkdir -p src test docs/superskills/plans

# Create a simple implementation plan
cat > docs/superskills/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/superskills/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/superskills/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"superskills:subagent-driven-development"' "$SESSION_FILE"; then
