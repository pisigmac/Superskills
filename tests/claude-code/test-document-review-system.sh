...
cat > docs/superskills/specs/test-feature-design.md <<'EOF'
# Test Feature Design
...
Then review the spec at $TEST_PROJECT/docs/superskills/specs/test-feature-design.md using the criteria from that template.
