...
> **For agentic workers:** REQUIRED: Use superskills:subagent-driven-development (if subagents available) or superskills:executing-plans to implement this plan.
...
**Spec:** docs/superskills/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/superskills/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use superskills:subagent-driven-development (if subagents available) or superskills:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
